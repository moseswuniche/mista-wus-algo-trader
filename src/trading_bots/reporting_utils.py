    ...
    try:
        ...
        <head>
            ...
            <style>
                ...
                img {{ margin-top: 15px; border: 1px solid #ccc; max-width: 90%; height: auto; display: block; margin-left: auto; margin-right: auto;}}
            </style>
        </head>
        <body>
            <h1>{report_title}</h1>
            ...
            <p><i>Note: Cumulative Profit and Final Balance calculated from trade log. Equity curve includes unrealized PnL during the period.</i></p>
        </body>
        </html>
        """
